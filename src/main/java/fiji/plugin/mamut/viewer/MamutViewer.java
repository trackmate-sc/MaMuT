...
public class MamutViewer extends SpimViewer implements TrackMateModelView {
	...
	public MamutViewer(final int width, final int height, final Collection<SourceAndConverter<?>> sources, final int numTimePoints, final Model model, final SelectionModel selectionModel) {
