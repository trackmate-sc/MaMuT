...
public class MamutBookmarksEditor
{
	...
	public MamutBookmarksEditor( final ViewerPanel viewer, final InputActionBindings inputActionBindings, final Bookmarks bookmarks )
	{
		this.viewer = viewer;
	...
	protected synchronized void init( final Mode mode, final String message )
	{
		initialKey = true;
		this.mode = mode;
		bindings.addInputMap( "bookmarks", inputMap, "mamut", "navigation", "bdv" );
		if ( animator != null )
			animator.clear();
